...
class TestGatewayContracts:
    def test_user_response_contract_compliance(self):
        ...
        user = UserContract(id="usr_90123", email="dev@cloudscale.io", full_name="Senior Developer", role="merchant")
    ...
    def test_order_contract_compliance(self):
        order = OrderContract(
            ...
            status="COMPLETED",
            total_amount=179.98,
            items=[OrderItemContract(product_id="prod_112233", quantity=2, price=89.99)],
        )
