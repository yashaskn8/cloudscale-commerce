...
# Request-scoped tenant context for RLS enforcement.
# Set this after decoding the JWT in auth middleware; read it in get_db_session().
...
def create_token_pair(
    ...
    Args:
        tenant_id: Tenant identifier included in the token for RLS enforcement.
                   If None, defaults to user_id (single-user-as-tenant model).
    """
